...
- corner.js (http://www.netzgesta.de/corner/) does it too with the option "ibezel" but only on images, and I needed it on blocks with content inside
...
- br : size of the Bottom Right bevel (default : 0)
